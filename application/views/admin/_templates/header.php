...
<html lang="<?php echo $lang; ?>">
    <head>
        ...
        <script language="JavaScript" type="text/javascript" src="<?php echo base_url($plugins_dir . '/slimscroll/slimscroll.min.js'); ?>"></script>
<?php if ($mobile === FALSE): ?>
        <!--[if IE 8]>
...
<?php endif; ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/datatables/css/dataTables.bootstrap.min.css'); ?>">
