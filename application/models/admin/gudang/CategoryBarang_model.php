...
class CategoryBarang_model extends CI_Model {
    ...
    var $column_order = array(null, 'category_id','category_name','category_desc'); //set column field database for datatable orderable
    var $column_search = array('category_id','category_name','category_desc'); //set column field database for datatable searchable 
